...
if(status.includes("crit")) pulso="pulse-critico";
else if(status.includes("atenção")) pulso="pulse-atencao";
else if(status.includes("alerta")) pulso="pulse-alerta";
else if(status.includes("adequado")) pulso="pulse-adequado";
}
...
feature.geometry &&
turf.booleanPointInPolygon([a.lng,a.lat], feature) // usando Turf.js para verificação exata
);
